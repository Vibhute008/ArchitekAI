    ...
    <div className="home">
      ...
      <section className="hero">
        <div className="announce">
          ...
          <span>Introducing ArchiteckAI 2.0</span>
        </div>

        <h1>Build beautiful spaces at the speed of thought with ArchiteckAI_</h1>

        <p className="subtitle">
          ArchiteckAI is an AI-first design environment that helps you visualize,
