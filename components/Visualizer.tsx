...
import ArchtekAILogo from "@/assets/ArchtekAILogo";
...
const Visualizer = ({
  ...
  const handleExport = () => {
    ...
    link.download = `architek-ai-render-${Date.now()}.png`;
    ...
    <div className="visualizer">
      ...
      <nav className="topbar">
        <div className="brand" onClick={onBack}>
          <ArchtekAILogo className="logo" />
          <span className="name">Architek AI</span>
        </div>
